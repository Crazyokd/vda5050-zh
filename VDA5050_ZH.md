...
  [6.1.5 走廊（Corridors）](#615-corridors)<br>
...
    [6.6.3 已释放段（Base）续发请求](#663-base-request)<br>
...
    [6.6.10 请求使用走廊（Corridor）](#6610-request-use-of-corridors)<br>
  [6.7 可视化（visualization）](#67-visualization)<br>
...
  [6.10 参数说明表（factsheet）](#610-factsheet)<br>
...
  [7.10 参数说明表（`factsheet`）消息实现](#710-implementation-of-the-factsheet-message)<br>
